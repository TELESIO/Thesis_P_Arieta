...
\subfloat[Acceleration]{\includegraphics[scale=0.085]{WithRumors}}    
\subfloat[Acceleration after filtering]{\includegraphics[scale=0.085]{NoRumors}}
...
\vspace{1.5cm}
\begin{figure}[H]	
\subfloat[Acceleration]{\includegraphics[scale=0.089]{NoRumors}} 
\subfloat[No Zero Velocity]{\includegraphics[scale=0.064]{NoVelocity}}
\end{figure}
\begin{figure}[H]
\centering
...
\begin{figure}[H]	
\centering
\subfloat[Unfiltered Signal]{\includegraphics[scale=0.12]{NoMovingFiltered}}    

\centering
\subfloat[Filtered Signal]{\includegraphics[scale=0.12]{MovingFiltered}}

\centering
\subfloat[Signal Overlapping]{\includegraphics[scale=0.12]{TotalFiltered}}
...
\begin{figure}[H]
\centering	
\subfloat[Filter Response]{\includegraphics[scale=0.34]{HPFResponse}}    

\subfloat[Unfiltered Signal]{\includegraphics[scale=0.12]{HPFUnfiltered}}
\end{figure}
\begin{figure}[H]
\centering
\subfloat[Filtered Signal]
{\includegraphics[scale=0.12]{HPFFiltered}}

\subfloat[Signal Overlapping]{\includegraphics[scale=0.12]{HPFOverlapped}}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.16]{fft}
...
\begin{figure}[H]	
\centering
\includegraphics[scale=0.35]{Problem} \label{GPS Points Problem}
