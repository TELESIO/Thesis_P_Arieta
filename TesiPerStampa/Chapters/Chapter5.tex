...
\begin{figure}[H]
 \centering
  ...
  \subfloat[Side view]{\includegraphics[scale=0.2]{Smartphone2}}
  
  \subfloat[View from above]{\includegraphics[scale=0.28]{Smartphone1}}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.14]{SPARaw}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.13]{SPANoEngine}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.13]{SPANoVelocity}
\caption{Signal after application of the filter}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.13]{SPAFinal}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.14]{CPRaw}
...
The result of the application of the filter on the signal shown above is:
 \begin{figure}[H]
\centering
\includegraphics[scale=0.13]{CPNoEngine}
...
The result of the application of the filter on the signal shown above is:
 \begin{figure}[H]
\centering
\includegraphics[scale=0.13]{CPNoVelocity}
...
The result of the application of this filter on the signal shown above	 is:
 \begin{figure}[H]
\centering
\includegraphics[scale=0.14]{CPUnderTH}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.15]{IRIAccelerationFiltering}
\caption{Acceleration Signal after the filters application}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.15]{IRITotalFiltering}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.32]{MainPage}
...
\begin{figure}[H]
  ...
  \subfloat[Min Zoom Level]{\includegraphics[scale=0.5]{MinZoom}}\hspace{10mm}
  \subfloat[Max Zoom Level]{\includegraphics[scale=0.5]{MaxZoom}}
