...
public class CriticalPointOnMapJDBC implements DAOPointOnMap {

	private Db_connection db_connection;
	
	public CriticalPointOnMapJDBC(Db_connection db_connection) {
	...
	public List<PointOnMap> getPointOnMap() {
		...
		try {
				String query = "select * from critical";
